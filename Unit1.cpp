...
#include "Unit2.h" // модуль форми "Про програму"
#include "Unit3.h" // модуль, що містить класи TPizza і TViewEvent
...
if(check==0)
{
    if (Application->MessageBox("Ви нічого не замовили",
            "Помилка",MB_OK)==IDOK);
}else
            { StringGrid2->Cells[0][0]="Ваше замовлення";
